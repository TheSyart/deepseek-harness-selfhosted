...
| [desktop.md](desktop.md) | the Electron carrier: portless profile composition, the sender-fenced IPC bridge, native local authority, and the `desktopStartup` service |
