...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  tokenUsageReport: 'token-meter.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  TokenUsageBuckets: 'token-meter.md',
  TokenUsageRoute: 'token-meter.md',
  TokenUsageDay: 'token-meter.md',
  TokenUsageReportRequest: 'token-meter.md',
  TokenUsageReportSnapshot: 'token-meter.md',
