...
import {
  ...
  tokenUsageTimelineProjectionDefinition,
...
export { tokenUsageTimelineSamples }
...
export class TokenMeter extends Service {
  ...
  constructor(ctx: Context, config: TokenMeterConfig = {}) {
    ...
    ctx.inject(['sessionProjections'], (projectionCtx) => {
      ...
      projectionCtx.sessionProjections.register(tokenUsageTimelineProjectionDefinition)
